...
export default function ParkingMonitor() {
  ...
  // Generate QR hanya ketika tombol ditekan menggunakan API
  const handleShowQR = (slotId) => {
    // Menggunakan API publik untuk membuat QR Code
    const qrContent = `PARKIR-${slotId}`;
  ...
  const slotsToDisplay = ["slot1", "slot2"];
